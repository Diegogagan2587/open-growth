class AddRepaymentDomainToFinancialLoans < ActiveRecord::Migration[8.0]
  def up
    ...
    add_reference :financial_loan_installments, :interest_entry, foreign_key: { to_table: :financial_entries }
  ...
  def down
    remove_reference :financial_loan_installments, :interest_entry, foreign_key: { to_table: :financial_entries }
