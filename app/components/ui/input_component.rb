...
class Ui::InputComponent < ViewComponent::Base
  ...
  def initialize(name:, value: nil, id: nil, type: "text", placeholder: nil, disabled: false, required: false, aria_invalid: false, data: {}, css_class: nil, min: nil, max: nil, step: nil, autocomplete: nil)
    @name = name
    @value = value
    @id = id
    @type = type
