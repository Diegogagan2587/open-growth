class Financial::PlannedTransactions::ExecutionsController < ApplicationController
  def create
    ...
    attrs = params.fetch(:planned_transaction, {}).permit(:amount, :transaction_date, :entry_date, :description, :category_id, :source_account_id, :destination_account_id).to_h.symbolize_keys
